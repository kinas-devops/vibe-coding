...
The first vibe-coding try is based on MasterMind game and if you want to play it go to my simple web version of the game at https://kinas-devops.github.io/vibe-coding/mastermind.html ...
